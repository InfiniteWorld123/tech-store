...
export function ReviewsFilters({ search, onSearchChange, rating, onRatingChange, onPrefetchRating }: ReviewsFiltersProps) {
		...
		<div className="flex flex-col sm:flex-row sm:items-center gap-3">
			...
			<div className="relative flex-1">
				...
				<input
					type="text"
					value={search}
					onChange={(e) => onSearchChange(e.target.value)} placeholder="Search reviews by title..."
			...
			<div className="relative">
				<Star size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted pointer-events-none" />
				<select
					value={rating ?? ""}
