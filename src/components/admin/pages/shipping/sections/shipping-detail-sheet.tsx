						...
						<div className="flex-1 space-y-6 overflow-y-auto p-3 sm:p-5">
							...
							<div>
								...
								<div className="space-y-3">
									...
									/>
									<div className="grid min-w-0 gap-1 min-[360px]:grid-cols-[6rem_minmax(0,1fr)] min-[360px]:gap-3">
										<span className="text-xs text-muted min-[360px]:pt-0.5">
											Tracking #
										</span>
										{displayItem.trackingNumber ? (
											<span className="flex min-w-0 items-start gap-1.5 text-left min-[360px]:justify-end min-[360px]:text-right">
