...
import { address, order, orderItem, payment, shipping, variant, variantImage } from "#/db/schema";
import { handleError } from "#/errors/error-handler";
import { and, eq, sql } from "drizzle-orm";
import type { GetCustomerOrderDetailInputType, GetCustomerOrderDetailOutputType } from "../customer.types";
import { notFoundError } from "#/errors/app-error";

export const getCustomerOrderDetail = async (data: GetCustomerOrderDetailInputType)
    ...
    try {
        ...
        const canCancel = ["pending", "processing"].includes(existingOrder.orderStatus);
