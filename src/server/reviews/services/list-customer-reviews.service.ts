...
import type {
	ListCustomerReviewsInputType,
	ListCustomerReviewsOutputType,
} from "../reviews.types";

export const listCustomerReviews = async (
	data: ListCustomerReviewsInputType,
): Promise<JsonOk<ListCustomerReviewsOutputType>> => {
	try {
		...
		return jsonOk<ListCustomerReviewsOutputType>({
