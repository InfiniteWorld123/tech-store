...
export const getProductMetrics = async (_data: GetProductMetricsInputType)
    ...
    try {
        ...
        return jsonOk({
            ...
            message: "Product metrics successfully fetched",
            data: {
                ...
                totalReviewsAcrossProducts: Number(productStats.totalReviewsAcrossProducts ?? 0),
