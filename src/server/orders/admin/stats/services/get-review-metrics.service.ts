...
import type { GetReviewMetricsInputType, GetReviewMetricsOutputType } from "../stats.types";




export const getReviewMetrics = async (_data: GetReviewMetricsInputType)
    ...
    try {
        ...
        return jsonOk({
            ...
            message: "Review metrics successfully fetched",
            data: {
                totalReviews: reviewStats.totalReviews,
                averageRating: Number(reviewStats.averageRating ?? 0),
                highestRatedProduct: Number(productRatingStats.highestRatedProduct ?? 0),
