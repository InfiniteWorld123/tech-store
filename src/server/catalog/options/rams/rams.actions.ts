...
import { createRamSchema, deleteRamSchema, deleteRamsSchema, listRamsSchema, updateRamSchema } from "./rams.schemas";
...
export const updateRamsAction = createServerFn({ method: "POST" })
    .middleware([ensureSession])
...
export const listRamsAction = createServerFn({ method: "POST" })
    .middleware([ensureSession])
